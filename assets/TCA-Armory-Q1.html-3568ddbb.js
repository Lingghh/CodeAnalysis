...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="无效值检查" tabindex="-1"><a class="header-anchor" href="#无效值检查" aria-hidden="true">#</a> 无效值检查</h2><p>包含规则</p><ul><li>unused_value</li></ul><h4 id="unused-value" tabindex="-1"><a class="header-anchor" href="#unused-value" aria-hidden="true">#</a> unused_value</h4><p>unused_value 检查那些赋予给变量的值是否正确被使用，存在连续两次赋予变量值的情况，视为第一次赋予的值未被正确使用，报出错误。 两次连续赋值可能存在条件控制语句出现错误、变量名拼写错误等情况。</p><h5 id="代码示例-3" tabindex="-1"><a class="header-anchor" href="#代码示例-3" aria-hidden="true">#</a> 代码示例</h5><p>以下提供一个或多个unused_value案例</p><p>以下函数会因为key的不同去不一样的神明，但实际上 Zeus Hades却永远不会使用到。</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>const char* key_value(const int key) {
    const char * value = 0;
    if (key != 0) {
        value = &quot;Zeus&quot;;
    } else if (key != 1) {
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="死代码检查" tabindex="-1"><a class="header-anchor" href="#死代码检查" aria-hidden="true">#</a> 死代码检查</h2><h4 id="dead-code" tabindex="-1"><a class="header-anchor" href="#dead-code" aria-hidden="true">#</a> dead_code</h4><p>dead_code 检查永远不会执行到的代码，主要为在同一作用域内 return, break 后的代码</p><h5 id="代码示例-12" tabindex="-1"><a class="header-anchor" href="#代码示例-12" aria-hidden="true">#</a> 代码示例</h5><p>以下提供一个或多个dead_code代码案例</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>// C/Cpp
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="dead-branch" tabindex="-1"><a class="header-anchor" href="#dead-branch" aria-hidden="true">#</a> dead_branch</h4><p>dead_branch 检查永远不会被执行到的分支代码，其原因可能是具有相同效果的控制语句或某些条件在特定情况下永远不会执行。</p><h5 id="代码示例-13" tabindex="-1"><a class="header-anchor" href="#代码示例-13" aria-hidden="true">#</a> 代码示例</h5><p>以下提供一个或多个dead_branch代码案例</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,125),s=[a];function r(v,u){return i(),n("div",null,s)}const t=e(l,[["render",r],["__file","TCA-Armory-Q1.html.vue"]]);export{t as default};
