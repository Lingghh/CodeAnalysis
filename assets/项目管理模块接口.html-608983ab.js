...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h4 id="参数列表-1" tabindex="-1"><a class="header-anchor" href="#参数列表-1" aria-hidden="true">#</a> 参数列表</h4><table><thead><tr><th>参数</th><th>类型</th><th>描述</th></tr></thead><tbody><tr><td>scm_url</td><td>str</td><td>必填，代码库地址</td></tr><tr><td>scm_type</td><td>str</td><td>必填，git或svn</td></tr><tr><td>ssh_url</td><td>str</td><td>选填，代码库SSH地址</td></tr><tr><td>name</td><td>str</td><td>选填， 代码库名称</td></tr><tr><td>scm_auth</td><td>dict</td><td>代码库授权</td></tr></tbody></table><p>例子:</p><div class="language-JSON line-numbers-mode" data-ext="JSON"><pre class="language-JSON"><code>{
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h4 id="参数列表-2" tabindex="-1"><a class="header-anchor" href="#参数列表-2" aria-hidden="true">#</a> 参数列表</h4><table><thead><tr><th>参数</th><th>类型</th><th>描述</th></tr></thead><tbody><tr><td>branch</td><td>str</td><td>分支名称</td></tr><tr><td>scan_scheme</td><td>int</td><td>扫描方案名称</td></tr><tr><td>scan_scheme__status</td><td>int</td><td>扫描方案状态，1为活跃，2为废弃</td></tr><tr><td>branch_or_scheme</td><td>str</td><td>分支名称/扫描方案名称</td></tr><tr><td>status</td><td>int</td><td>项目状态筛选，1表示活跃，2表示失活，3表示关闭</td></tr></tbody></table><h4 id="返回结果-5" tabindex="-1"><a class="header-anchor" href="#返回结果-5" aria-hidden="true">#</a> 返回结果</h4><div class="language-JSON line-numbers-mode" data-ext="JSON"><pre class="language-JSON"><code>{
    &quot;data&quot;: {
        &quot;count&quot;: 1,
        &quot;next&quot;: null,
        &quot;previous&quot;: null,
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h4 id="参数列表-3" tabindex="-1"><a class="header-anchor" href="#参数列表-3" aria-hidden="true">#</a> 参数列表</h4><table><thead><tr><th>参数</th><th>类型</th><th>描述</th></tr></thead><tbody><tr><td>scan_scheme_id</td><td>int</td><td>当前代码库的扫描方案编号</td></tr><tr><td>global_scheme_id</td><td>int</td><td>扫描方案模板编号</td></tr><tr><td>custom_scheme_name</td><td>str</td><td>自定义方案名称</td></tr><tr><td>branch</td><td>str</td><td>分支</td></tr><tr><td>created_from</td><td>str</td><td>创建渠道，用于区分不同运行场景</td></tr></tbody></table><h4 id="返回结果-6" tabindex="-1"><a class="header-anchor" href="#返回结果-6" aria-hidden="true">#</a> 返回结果</h4><div class="language-JSON line-numbers-mode" data-ext="JSON"><pre class="language-JSON"><code>{
    &quot;data&quot;: {
        &quot;id&quot;:1,
        &quot;creator&quot;: {
            &quot;username&quot;: &quot;username&quot;,
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h4 id="参数列表-8" tabindex="-1"><a class="header-anchor" href="#参数列表-8" aria-hidden="true">#</a> 参数列表</h4><table><thead><tr><th>参数</th><th>类型</th><th>描述</th></tr></thead><tbody><tr><td>dir_path</td><td>str</td><td>指定过滤路径</td></tr><tr><td>path_type</td><td>int</td><td>路径格式，1表示通配符，2表示正则表达式，默认为通配符</td></tr><tr><td>scan_type</td><td>int</td><td>扫描类型，1表示包含，2表示排除</td></tr></tbody></table><h4 id="返回结果-16" tabindex="-1"><a class="header-anchor" href="#返回结果-16" aria-hidden="true">#</a> 返回结果</h4><div class="language-JSON line-numbers-mode" data-ext="JSON"><pre class="language-JSON"><code>{
    &quot;data&quot;: {
        &quot;id&quot;: 13,
        &quot;dir_path&quot;: &quot;test/*.py&quot;,
        &quot;path_type&quot;: 1,
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h4 id="参数列表-9" tabindex="-1"><a class="header-anchor" href="#参数列表-9" aria-hidden="true">#</a> 参数列表</h4><table><thead><tr><th>参数</th><th>类型</th><th>描述</th></tr></thead><tbody><tr><td>dir_path</td><td>str</td><td>指定过滤路径</td></tr><tr><td>path_type</td><td>int</td><td>路径格式，1表示通配符，2表示正则表达式，默认为通配符</td></tr><tr><td>scan_type</td><td>int</td><td>扫描类型，1表示包含，2表示排除</td></tr></tbody></table><h4 id="返回结果-18" tabindex="-1"><a class="header-anchor" href="#返回结果-18" aria-hidden="true">#</a> 返回结果</h4><div class="language-JSON line-numbers-mode" data-ext="JSON"><pre class="language-JSON"><code>{
    &quot;data&quot;: {
        &quot;id&quot;: 13,
        &quot;dir_path&quot;: &quot;test/*.py&quot;,
        &quot;path_type&quot;: 1,
